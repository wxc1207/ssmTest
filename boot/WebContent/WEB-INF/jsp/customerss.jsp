...
<body>
   <!--上面-->
	<div style="width: 100%; height: 60px;border:5px solid red;">
	...
	<!--下面-->
	<div style="width: 100%; height: 70%;border:5px solid black;">
		<!-- 左侧 -->
		<div style="float:left; border:5px solid red;width: 15%; height: 100px;" >
			<div class="input-group" >
            <input type="text" class="form-control" placeholder="搜索内容..." width="40px"> 
		...
		<div>
		<!-- 右侧 -->
		<div style=" float:left;border:5px solid blue;width: 83%; height: 100%;">
		<!-- /.row -->
		<h2>客户管理</h2>
				...
				<form class="form-inline" method="get" 
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="customerName" 
						                   value="${custName }" name="custName" placeholder="请输入客户名称" />
					</div>
					<div class="form-group">
...
<div class="modal fade" id="customerEditDialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <button type="button" class="btn btn-primary" onclick="updateCustomer()">确认修改</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>
